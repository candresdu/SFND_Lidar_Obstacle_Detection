...
// Submission to Lidar and Object detection project. Sensor Fusion Nanodegree
...
void cityBlock(pcl::visualization::PCLVisualizer::Ptr& viewer, ProcessPointClouds<pcl::PointXYZI>* ppc, const pcl::PointCloud<pcl::PointXYZI>::Ptr& inputCloud)
{
    ...
    // Plane segmentation must be done using custom method
    std::pair<pcl::PointCloud<pcl::PointXYZI>::Ptr, pcl::PointCloud<pcl::PointXYZI>::Ptr> segmentCloud = ppc->SegmentPlane(filteredCloud, 10, 0.2);
    renderPointCloud(viewer,segmentCloud.first,"obstCloud",Color(1,0,0));
    renderPointCloud(viewer,segmentCloud.second,"planeCloud",Color(0,1,0));
  
    // All clustering code goes here and must be done using custom method
